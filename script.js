...
const ppozButtonsArray = [
  "Instrukcja bezpieczeństwa pożarowego",
  "Operat przeciwpożarowy",
  "Ekspertyza ppoż",
  "Uzgadnianie projektów architektoniczno-budowlanych",
  "Nadzór ppoż. nad bezpieczeństwem pożarowym",
];
const atexButtonsArray = [
  "Ocena zagrożenia wybuchem",
  "Ocena Ryzyka Wybuchu",
  "Dokument zabezpieczenia przed wybuchem",
];
const sevesoButtonsArray = [
  "Dokumentacja SEVESO",
  "Raport o Bezpieczeństwie",
  "Wewnętrzny Plan Operacyjno-Ratowniczy",
  "Program Zapobiegania Awariom",
];
const trainingButtonsArray = [
  "Szkolenia PPOŻ",
  "Szkolenia BHP",
...
window.addEventListener("scroll", () => {
  ...
  const aboutUsSectionHeig =
    document.querySelector(".about-us").clientHeight + headerHeight;
