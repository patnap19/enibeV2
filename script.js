...
const descPpozArray = [
    {
        ...
        desc: `Instrukcja Bezpieczeństwa Pożarowego odgrywa istotną rolę w zapewnianiu odpowiedniego
        poziomu bezpieczeństwa w miejscach pracy oraz obiektach użyteczności publicznej.
    ...
    },
    {
        ...
        pożarowe w budynku odpowiada jego właściciel, zarządca bądź użytkownik .
    ...
    },
    {
        ...
        sprawować zewnętrzni eksperci na podstawie stosownych ustaleń.
        W ramach współpracy z naszymi klientami i partnerami realizujemy kompleksowy nadzór PPOŻ nad
        bezpieczeństwem pożarowym budynku, który obejmuje:
         okresowe i bieżące wykonywanie audytów bezpieczeństwa pożarowego;
        ...
        przeciwpożarowych;
         opracowanie oraz aktualizację Instrukcji Bezpieczeństwa Pożarowego;
...
const descAtexArray = [
    {
        ...
        powinien opracować dokument pt. ocena zagrożenia wybuchem.
    ...
    },
    {
        ...
        jest ocena ryzyka związanego z możliwością wystąpienia atmosfery wybuchowej.
        ...
        produkcyjnego.
        Ocena ryzyka wybuchu, jest oceną całościową biorącą pod uwagę m. in.:
         używane urządzenia do wykonywania pracy
         cechy charakterystyczne budynków, instalacji zakładu
         używane substancje
         warunki pracy i procesy produkcyjne
    ...
    },
    {
        ...
        możliwością wystąpienia w miejscu pracy atmosfery wybuchowej (Dz. U. Nr 138, poz. 931).
